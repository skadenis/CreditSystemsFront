...
import leadStatusName from "@/filters/leadStatusName";
import productTypeName from "@/filters/productTypeName";
import productMethodName from "@/filters/productMethodName";
import currensyName from "@/filters/currensyName";
...
Vue.filter("leadStatusName", leadStatusName);
Vue.filter("productTypeName", productTypeName);
Vue.filter("productMethodName", productMethodName);
Vue.filter("currensyName", currensyName);
